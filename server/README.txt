...
this installs the rest3d eXist app folders and templates
...
+ Note about the rest3d eXist app
...
note, you can change the port served by nodejs using the environment variable 'HTTP'
